...
enum en_PACKET_MONITORING_TYPE
{
	...
	//
	//------------------------------------------------------------
	en_PACKET_LOGINSERVER_MONITOR_DATA_UPDATE,
	...
	//
	//------------------------------------------------------------
	en_PACKET_GAMESERVER_MONITOR_DATA_UPDATE,
	...
	//
	//------------------------------------------------------------
	en_PACKET_CHATTINGSERVER_MONITOR_DATA_UPDATE,
